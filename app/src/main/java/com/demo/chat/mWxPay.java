 ...
 */
public class mWxPay extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chatpay);
        ...
        checkPayBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(mWxPay.this, String.valueOf(isPaySupported), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private class GetAccessTokenTask extends AsyncTask<Void, Void, GetAccessTokenResult> {
        ...
        protected void onPreExecute() {
            dialog = ProgressDialog.show(mWxPay.this,"提示", "正在获取access token...");
        }
        ...
        protected void onPostExecute(GetAccessTokenResult result) {
            ...
            if (result.localRetCode == LocalRetCode.ERR_OK) {
                Toast.makeText(mWxPay.this, "获取access token成功", Toast.LENGTH_LONG).show();
//                Log.d(TAG, "onPostExecute, accessToken = " + result.accessToken);

                GetPrepayIdTask getPrepayId = new GetPrepayIdTask(result.accessToken);
                getPrepayId.execute();
            } else {
                Toast.makeText(mWxPay.this, "获取access token失败"+result.localRetCode.name(), Toast.LENGTH_LONG).show();
            }
        }
...
//            Log.d(TAG, "get access token, url = " + url);
    ...
    private class GetPrepayIdTask extends AsyncTask<Void, Void, GetPrepayIdResult> {
        ...
        @Override
        protected void onPreExecute() {
            dialog = ProgressDialog.show(mWxPay.this, "提示", "正在获取预支付订单...");
        }
        ...
        protected void onPostExecute(GetPrepayIdResult result) {
            ...
            if (result.localRetCode == LocalRetCode.ERR_OK) {
                Toast.makeText(mWxPay.this, "获取prepayid成功", Toast.LENGTH_LONG).show();
                sendPayReq(result);
            } else {
                Toast.makeText(mWxPay.this, "获取prepayid失败"+result.localRetCode.name(), Toast.LENGTH_LONG).show();
            }
        }
