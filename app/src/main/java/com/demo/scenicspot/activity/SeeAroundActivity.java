 ...
 */
public class SeeAroundActivity extends AppCompatActivity implements LocationSource, AMapLocationListener, View.OnClickListener, PoiSearch.OnPoiSearchListener, AMap.OnMarkerClickListener, AMap.InfoWindowAdapter {
...
//        getSupportActionBar().hide();
    ...
    private void setUp() {
        ...
        button1 = (TextView) findViewById(R.id.search_button);
    ...
    private void search() {
        ...
        Log.i("---", keyWord);
        if ("".equals(keyWord)) {
            Toast.makeText(SeeAroundActivity.this, "请输入搜索关键字", Toast.LENGTH_SHORT).show();
            return;
        } else {
            doSearchQuery();
        }
...
//        Toast.makeText(SeeAroundActivity.this, infomation, Toast.LENGTH_SHORT).show();
            ...
            if (poiResult != null && poiResult.getQuery() != null) {// 搜索poi的结果
                if (poiResult.getQuery().equals(query)) {// 是否是同一条
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(SeeAroundActivity.this, "未找到结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(SeeAroundActivity.this, "该距离内没有找到结果", Toast.LENGTH_SHORT).show();
            }
        } else {
            Log.i("---", "查询结果:" + i);
            Toast.makeText(SeeAroundActivity.this, "异常代码---" + i, Toast.LENGTH_SHORT).show();
        }
    ...
    public View getInfoWindow(final Marker marker) {
        ...
        ImageView button = (ImageView) view.findViewById(R.id.start_amap_app);
        // 调起高德地图app
