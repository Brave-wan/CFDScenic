 ...
 */
public class MyRecreationSpAdapter extends BaseAdapter {
    Context mContext;
    ...
    public MyRecreationSpAdapter(Context mContext) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            cyzMode=new CyzMode();
            convertView= LayoutInflater.from(mContext).inflate(R.layout.adapter_my_recreation_sp,null);
            ...
            cyzMode.mVideoView= (VideoView) convertView.findViewById(R.id.mVideoView);
    ...
    public class SetOnClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.fl_shipin:
                    Toast.makeText(mContext,"查看视频",Toast.LENGTH_LONG).show();
                    break;
            }
        }
    }
