...
/**
 * 作者： on 2016/7/29 0029 14:34
 */
public class HomeSeienceListViewadapter extends BaseAdapter {
    Context context;
    private LayoutInflater mInflater;//布局装载器对象
    Intent intent = new Intent();
    List<ScenicSpotListBean.DataBean> list;

    public HomeSeienceListViewadapter(Context context, List<ScenicSpotListBean.DataBean> list) {
