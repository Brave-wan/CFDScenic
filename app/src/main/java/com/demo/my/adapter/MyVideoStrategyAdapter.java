...
/**
 * 作者：sonnerly on 2016/12/9 0009 11:33
 */
public class MyVideoStrategyAdapter extends BaseAdapter {
    Context mContext;
    ...
    String[] s;
    public MyVideoStrategyAdapter(Context mContext,List<CircleCommentBean.DataBean.RowsBean> list) {
...
//        create_Bean(5);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            cyzMode.deletedelete= (ImageView) convertView.findViewById(R.id.deletedelete);
            convertView.setTag(cyzMode);
        }else {
            cyzMode= (CyzMode) convertView.getTag();
        }
        cyzMode.deletedelete.setVisibility(View.VISIBLE);
...
//        }
        ...
        cyzMode.ll_fenxiang.setOnClickListener(new SetOnClick(cyzMode,position));
        cyzMode.deletedelete.setOnClickListener(new SetOnClick(cyzMode,position));
        return convertView;
    }
