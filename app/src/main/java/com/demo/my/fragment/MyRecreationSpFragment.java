...
import com.demo.my.adapter.MyVideoStrategyAdapter;
 ...
 */
public class MyRecreationSpFragment extends Fragment implements XListView.IXListViewListener {
    ...
    MyVideoStrategyAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mPage = 1;
        list = new ArrayList<>();
        adapter = new MyVideoStrategyAdapter(getActivity(), list);
    ...
    public void getWonderful() {
        ...
        params.addQueryStringParameter("isAll", 1 + "");
